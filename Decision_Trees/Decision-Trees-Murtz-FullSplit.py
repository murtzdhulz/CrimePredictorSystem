...
class DecisionTree():
    ...
    def build_sub_tree(self, features, classes, depth=0, traversed_features=[]):
        ...
        print "Length of traversed branch here is:",len(traversed_branch)
        print "Traversed branch is",traversed_branch
        ...
        for i in range(len(features[0])):
            print "Calculating the best gain for",i
            if i in traversed_branch:
                print "skipping the parameter",i
                continue
            cur_best_left = []
            cur_best_right = []
            ...
            if i==0:
                print "Checking all splits for day"
                for p in range(1,8):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                ...
                print "Checking all splits for district"
                for p in range(1,11):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                ...
                print "Checking all splits for date"
                for p in range(1,31):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                ...
                print "Checking all splits for month"
                for p in range(1,13):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                ...
                print "Checking all splits for year"
                for p in range(2003,2016):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                    list_left = []
                ...
                print "Checking all splits for hour"
                for p in range(0,24):
                    cur_split_point = p
                    features_left = []
                    features_right = []
                ...
                print "Checking all splits for minute"
                for p in range(0,60):
                    cur_split_point = p
                    features_left = []
                    features_right = []
            ...
            '''
                ...
                continue
                print "Checking all splits for latitude or longitude"
...
dataset = load_csv('Murtaza/ARSON.csv')
